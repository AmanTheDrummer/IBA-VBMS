...
exports.BuildingsModule = BuildingsModule = __decorate([
    (0, common_1.Module)({ imports: [auth_module_1.AuthModule], providers: [buildings_service_1.BuildingsService], controllers: [buildings_controller_1.BuildingsController] })
], BuildingsModule);
