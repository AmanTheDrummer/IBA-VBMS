...
let BuildingsController = class BuildingsController {
    ...
    findOne(id) { return this.buildings.findOne(id); }
    create(dto) { return this.buildings.create(dto); }
    remove(id) { return this.buildings.remove(id); }
};
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [buildings_service_1.CreateBuildingDto]),
    __metadata("design:returntype", void 0)
